...
description = ""
quote_of_the_day = 'Небесното царство е подобно на съкровище скрито в поле; което когато човек е намерил, скрива, и от радост отива и продава всичко което има, и купува това поле [Матей 13:44]'
