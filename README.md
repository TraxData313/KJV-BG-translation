# Български превод на Библията от KJV (на пауза)
От началото на 2025 не работя по превода. Може би няма да го възстановя скоро.
