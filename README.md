...
- Използвам автоматични алгоритми за минимизиране на грешките, поддръжка на логове и компилиране на уебсайта, който хоствам с AWS S3 на този уебсайт [BG KJV Книги](http://site-for-kjv-bg-translation.s3-website-us-east-1.amazonaws.com/)
...
- Работя в свободното си време, без интереси за финансови или други лични изгоди
...
## Напредък
- Думи в речника: [35.7%] или [4420 от 12384], ETA: [2027-12-04]
- Думи в текста: [92.8%] или [725095 от 781606], ETA: [2027-06-18]
- Стихове: [2.5%] или [785 от 31102], ETA: [2053-07-03]
- С текущия темп цялостният груб превод ще завърши около [2032-10-26]
